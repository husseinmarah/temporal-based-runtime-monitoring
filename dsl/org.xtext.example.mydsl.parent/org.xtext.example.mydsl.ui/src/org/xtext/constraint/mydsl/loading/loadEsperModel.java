...
public class loadEsperModel {
    public static EsperEngine load() {
		...
		Resource resource = resSet.getResource(
				URI.createURI("file:///C:/Users/Hussein/eclipse-workspace-dsl-demo/org.xtext.example.mydsl.parent/at.jku.se.mosumo.dronology.constraint.esper/model/EsperEngine.xmi"),
				true);
