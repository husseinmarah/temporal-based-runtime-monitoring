 ...
 *   <li>{@link at.jku.se.mosumo.dronology.constraint.esper.impl.ConstraintImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint {
	...
	public void setTopic(String newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsperPackage.CONSTRAINT__TOPIC, oldTopic, topic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EsperPackage.CONSTRAINT__AGENT:
			return getAgent();
		case EsperPackage.CONSTRAINT__TOPIC:
			return getTopic();
		}
