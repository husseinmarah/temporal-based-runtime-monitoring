...
public interface EsperPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONSTRAINT_FEATURE_COUNT = 9;
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.se.mosumo.dronology.constraint.esper.Constraint#getTopic <em>Topic</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Topic</em>'.
	 * @see at.jku.se.mosumo.dronology.constraint.esper.Constraint#getTopic()
	 * @see #getConstraint()
	 * @generated
	 */
	EAttribute getConstraint_Topic();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute CONSTRAINT__TOPIC = eINSTANCE.getConstraint_Topic();
