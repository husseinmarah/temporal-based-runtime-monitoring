 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.se.mosumo.dronology.constraint.esper.impl.ListenerImpl#getName <em>Name</em>}</li>
...
public class ListenerImpl extends MinimalEObjectImpl.Container implements Listener {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsperPackage.LISTENER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EsperPackage.LISTENER__NAME:
			return getName();
		case EsperPackage.LISTENER__LOGGER:
			return getLogger();
		}
