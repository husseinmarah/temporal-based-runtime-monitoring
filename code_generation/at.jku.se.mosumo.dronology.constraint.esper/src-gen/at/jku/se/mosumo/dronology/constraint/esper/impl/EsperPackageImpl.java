...
public class EsperPackageImpl extends EPackageImpl implements EsperPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConstraint_StatementSubscriber(), ecorePackage.getEString(), "statementSubscriber", null, 0,
				...
				!IS_DERIVED, IS_ORDERED);
		initEReference(getConstraint_Listener(), this.getListener(), null, "listener", null, 0, 1, Constraint.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(listenerEClass, Listener.class, "Listener", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getListener_Name(), ecorePackage.getEString(), "name", null, 0, 1, Listener.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getListener_Logger(), this.getLogger(), null, "logger", null, 0, 1, Listener.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
